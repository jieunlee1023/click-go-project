			...
			<div class="d-flex-column">
				...
				<c:choose>
					<c:when test="${empty reviewList.content}">
						...
						<h5>${principal.user.username}님의리뷰는 click go와 가맹점 개선에 큰 힘이
							됩니다 !</h5>
					</c:when>
								...
								<div class="media-body">
									<div class="d-flex justify-content-between m-2 ml-3">
										...
										<div>
											...
											<span class="m-1 mr-2">${review.user.username}님</span>
												<span class="m-1 mr-2">${review.store.storeName}</span>
												 <span
													class="m-1 mr-2">게시 날짜 :${review.createDate}</span> 
													<span
