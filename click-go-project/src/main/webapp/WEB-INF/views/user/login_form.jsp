...
<!-- 		<a href="https://kauth.kakao.com/oauth/authorize?client_id=a3af89fb8269257123c6854ffafc500d&redirect_uri=http://localhost:9090/auth/kakao/callback&response_type=code">
		...
		<a href="https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=BvSSlS3rTAUDe0wev5Qa&state=<%=state%>&redirect_uri=<%=redirectURI %>">
			<img alt="네이버로그인" src="/image/naver_btn.png" width="70" height="40"></a>
