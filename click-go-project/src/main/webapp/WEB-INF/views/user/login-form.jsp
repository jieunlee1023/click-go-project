...
<div class="container d-flex justify-content-center"
	...
	<div class="container">
		<form action="/auth/loginProc" method="post">
			...
			<div class="form-group ">
				<label for="password"  class="d-flex m-0" style="font-size: 13px">비밀번호</label> <input type="password"
		...
		<div class="d-flex justify-content-between pt-2">
			<a id="id-password-btn" style="font-size: 12px; color: black" href="">아이디/비밀번호 찾기</a> 
				<a id="signin-btn" style="font-size: 12px; color: black" href="/auth/join_form">회원가입</a>
		</div>
		<br>
		<div class="d-flex justify-content-center">
			...
			<a class="d-flex m-1"
				...
				height="50">
			</a> <a class="d-flex m-1" href="#"> <img alt="구글로그인"
				src="/image/google_login.png" width="50" height="50">
			</a>
		</div>
	</div>
</div>
