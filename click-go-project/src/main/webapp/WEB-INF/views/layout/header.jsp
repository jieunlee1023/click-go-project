	...
	<div>
		...
		<nav class="navbar navbar-expand-md " style="padding-top: 10px;">
			...
			<div class="d-flex justify-content-center ">
				...
				<a class="navbar-brand" href="/" style="color: black"> <img src="../image/favicon.png" alt="logo" style="width: 50px;" class="m-2">Click
					Go
				</a>
			...
			<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#collapsibleNavbar">
				<span class="navbar-toggler-icon"> <img src="../image/menu.png" width="30px" height="30px">
				</span>
			</button>
