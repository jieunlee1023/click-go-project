...
<div id="full-page">
	...
	<div class="section s0 ">
		...
		<div class="container mt-5">
			<div id="main--item">
				<div id="main--text">
					<img src="/image/index/textImg1.png" width="600px"> <br>
				...
				<div id="main--img">
					<img src="/image/index/computer.png" width="600px">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="section s1">
		<div class="container mt-5">
			<div id="main--item">
				<div id="main--text">
					<img src="/image/index/textImg2.png" width="600px"> <br>
					<div class="main--text--add">장소에 도착해서 기다리지 않아도 돼요.</div>
					<div class="main--text--add">그냥 내자리 이미 준비 완료!</div>
				</div>
				<div id="main--img2">
					<img src="/image/index/billiards.png" width="600px">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="section s4">
		<div class="container mt-5">
			<div id="main--item">
				<div id="main--text">
					<img src="/image/index/textImg5.png" width="600px"> <br>
					<div class="main--text--add">각종 신용카드는 물론,</div>
					<div class="main--text--add">카카오페이까지 결제 가능!</div>
				</div>
				<div id="main--img5">
					<img src="/image/index/payment.png" width="600px">
				</div>
			</div>
		</div>
	</div>
