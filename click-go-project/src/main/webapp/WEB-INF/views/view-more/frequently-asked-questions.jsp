				...
				<c:if test="${questNum == 2}">
					...
					<div class="card">
						...
						<div id="collapse6" class="collapse" data-parent="#accordion">
							<div class="card-body d-flex justify-content-center"
								style="background: #d5d5d5">결제 영수증은 결제수단에 따라 확인/발급 방법이
				...
				<c:if test="${questNum == 4}">
					<div class="card">
						...
						<div id="collapse13" class="collapse" data-parent="#accordion">
							<div class="card-body d-flex justify-content-center"
								style="background: #d5d5d5">쿠팡 고객센터는 365일 24시간 연중무휴로
								운영합니다.</div>
						</div>
					</div>
				...
				<c:if test="${questNum == 9}">
					...
					<div class="card">
						...
						<div id="collapse35" class="collapse" data-parent="#accordion">
							<div class="card-body d-flex justify-content-center"
								style="background: #d5d5d5">개인 회원과 사업자 회원은 다른 회원으로 구분됩니다.
