			...
			<c:if test="${questNum == 1}">
				...
				<div class="card">
					...
					<div id="collapse1" class="collapse" data-parent="#accordion">
						<div class="card-body d-flex justify-content-center">
							...
							방식으로 상담이 가능하오니 연결 지연 시 1:1문의, 클릭고톡을 통해 상담을 부탁드립니다.
						</div>
					</div>
				</div>
				...
				<div class="card">
					...
					<div id="collapse3" class="collapse" data-parent="#accordion">
						<div class="card-body d-flex justify-content-center">
							상세페이지 > 오른쪽 상단의 공유하기 아이콘을 클릭하시면 클릭고톡, 문자메시지로 빠르게 공유할 수 있습니다.<br>
				...
				<div class="card">
					...
					<div id="collapse5" class="collapse" data-parent="#accordion">
						<div class="card-body d-flex justify-content-center">
							...
							[간편계좌이체 / Click_Go / PAYCO]<br> - 결제 단계에서 현금영수증 신청하면 자동으로 발행<br>
							- 단, 간편계좌이체의 경우 신청 누락 시 클릭고 고객행복센터로 요청<br> <br> [클릭고페이]<br>
							- 클릭고페이머니 결제 시 자동으로 발행<br> - 자진발급 : 클릭고톡 > pay > 우측톱니바퀴(나의
							클릭고페이) > 이용내역 > 결제 > 개별 상세내역 > 현금영수증 확인
						</div>
					</div>
				</div>
				...
				<div class="card">
					...
					<div id="collapse6" class="collapse" data-parent="#accordion">
						<div class="card-body d-flex justify-content-center">결제 영수증은
							...
							클릭고 앱 > 하단 내정보 > 예약/구매내역 > 결제 증빙 보기 - 예약내역이 삭제되었을 경우 클릭고페이먼츠
							홈페이지에서 조회 [휴대폰 결제, PAYCO, 클릭고페이, 클릭고, 간편계좌이체] - 클릭고 앱 > 하단 내정보 >
				...
				<div class="card">
					...
					<div id="collapse7" class="collapse" data-parent="#accordion">
						<div class="card-body d-flex justify-content-center">
							간편계좌이체, Click_Go에 계좌 등록 시 은행에서 자동이체 서비스가 등록되었다는 문자가 발송될 수 있습니다.<br>
